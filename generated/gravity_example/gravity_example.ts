...
export class gravity_example__getGravatarResult {
  value0: string;
  value1: string;
...
export class gravity_example__gravatarsResult {
  value0: Address;
  value1: string;
  value2: string;
...
export class gravity_example extends ethereum.SmartContract {
  static bind(address: Address): gravity_example {
    return new gravity_example("gravity_example", address);
  }

  getGravatar(owner: Address): gravity_example__getGravatarResult {
    ...
    return new gravity_example__getGravatarResult(
      result[0].toString(),
      result[1].toString()
    );
  }
  ...
  try_getGravatar(
    owner: Address
  ): ethereum.CallResult<gravity_example__getGravatarResult> {
    ...
    return ethereum.CallResult.fromValue(
      new gravity_example__getGravatarResult(
        value[0].toString(),
        value[1].toString()
      )
    );
  ...
  gravatars(param0: BigInt): gravity_example__gravatarsResult {
    let result = super.call(
      "gravatars",
    ...
    return new gravity_example__gravatarsResult(
      result[0].toAddress(),
      result[1].toString(),
      result[2].toString()
    );
  ...
  try_gravatars(
    param0: BigInt
  ): ethereum.CallResult<gravity_example__gravatarsResult> {
    let result = super.tryCall(
      "gravatars",
      "gravatars(uint256):(address,string,string)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new gravity_example__gravatarsResult(
        value[0].toAddress(),
        value[1].toString(),
        value[2].toString()
      )
